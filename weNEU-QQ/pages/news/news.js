...
Page({
  data: {
    ...
    list: [{
        ...
        name: '东大新闻网',
        storage: [],
        url: '06-01getNEUnews/06-01grabNEU_list.php',
        subType: ["东大要闻", "媒体东大", "通知公告", "新闻纵横", "学术科研", "招生就业", "考研出国"]
      },
      {
        id: 1,
        'type': 'jw',
        name: '教务公告',
        storage: [],
        url: '06-02getAAOnews/06-02grabAAO_list.php',
        subType: ["新闻纵横", "通知", "公告", "研究生通知", "教学管理与研究", "素质教育"]
      },
      {
        id: 2,
        'type': 'new',
        name: '软件学院',
        storage: [],
        url: "06-03getCollegenews/06-03-01grabSE_list.php",
        subType: ["通知公告", "学院新闻", "本科生通知", "学生工作", "人才培养", "学生园地"]
      }
      // ,
